...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	{
		public const byte RPC_ON_PLAYER_ID = 0 + 5;
		public const byte RPC_GET_PLAYER_ID = 1 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("OnPlayerId", OnPlayerId, typeof(uint));
			networkObject.RegisterRpc("GetPlayerId", GetPlayerId);
		...
		/// uint playerId
		/// </summary>
		public abstract void OnPlayerId(RpcArgs args);
		/// <summary>
		/// Arguments:
		/// </summary>
		public abstract void GetPlayerId(RpcArgs args);
